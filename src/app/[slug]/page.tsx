...
export default async function Home({
  ...
  return (
    <section className="relative h-[100svh] w-full overflow-hidden bg-black">
      <Image
        src={`/grand-theft-${slug}.png`}
        alt={`Grand Theft MatTech ${slug}`}
        fill
        priority
        sizes="100vw"
        className="object-cover"
      />
      <div className="container relative z-10 flex h-full flex-col items-center justify-center p-4 text-center">
        <h1
